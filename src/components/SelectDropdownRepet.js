import React, {
  ...
  const SelectDropdownRepet = (
    ...
    const setDefault = (index) => {
      setSelectedItem(data[index].name);
      setIndex(index);
    };
                      ...
                      >
                        {renderCustomizedRowChild ? (
                          <View style={[styles.dropdownCustomizedRowParent]}>
                            {renderCustomizedRowChild(
                              rowTextForSelection
                                ? rowTextForSelection(item.name, index)
                                : item.name,
                              index
                            )}
                          </View>
  ...
  export default forwardRef((props, ref) => SelectDropdownRepet(props, ref));